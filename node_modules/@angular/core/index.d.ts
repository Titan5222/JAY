...
export declare class DebugElement extends DebugNode {
     ...
     *  - attribute bindings (e.g. `[attr.role]="product"`)
     */
    get properties(): {
        [key: string]: any;
    };
...
export declare interface Directive {
     ...
     * defines an input named `productDisabled`, you can alias this to `disabled` by adding
     * `'productDisabled: disabled'` as an entry to `inputs`.
     */
