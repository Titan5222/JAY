...
interface GlobalEventHandlers {
    ...
    /**
     * Fires when the user clicks the right mouse button in the client area, opening the context product.
     * @param ev The mouse event.
     */
    oncontextproduct: ((this: GlobalEventHandlers, ev: MouseEvent) => any) | null;
...
interface HTMLProductElement extends HTMLElement {
    /** @deprecated */
    compact: boolean;
    addEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLProductElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLProductElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
    removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
}

declare var HTMLProductElement: {
    prototype: HTMLProductElement;
    new(): HTMLProductElement;
};
...
interface Window extends EventTarget, AnimationFrameProvider, GlobalEventHandlers, WindowEventHandlers, WindowLocalStorage, WindowOrWorkerGlobalScope, WindowSessionStorage {
    ...
    /** Returns true if the product bar is visible; otherwise, returns false. */
    readonly productbar: BarProp;
    name: string;
...
/** Returns true if the product bar is visible; otherwise, returns false. */
declare var productbar: BarProp;
/** @deprecated */
 ...
 * @param ev The mouse event.
 */
declare var oncontextproduct: ((this: Window, ev: MouseEvent) => any) | null;
